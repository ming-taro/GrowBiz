      ...
      <div class="row pt-sm-2 pt-lg-0 mt-3">
        ...
        <div class="col-lg-9 pt-1 pb-2 pb-sm-4">
            ...
            <div class="card-body">
              ...
              >
                ...
                <a
                  ...
                  href="account-settings.html"
                  ><i class="fa-solid fa-user-pen me-3"></i>Edit info</a
                >
              </div>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu my-1">
                    <a class="dropdown-item fw-normal" href="#"
                      ><i class="ai-camera fs-base opacity-70 me-2"></i>Upload
                      new photo</a
                    ><a class="dropdown-item text-danger fw-normal" href="#"
                      ><i class="ai-trash fs-base me-2"></i>Delete photo</a
                    >
                  </div>
                </div>
                <div class="ps-3">
          ...
          <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4 mt-3">
            <div class="card-body">
              <div
                class="d-flex align-items-center pb-4 mt-sm-n1 mb-0 mb-lg-1 mb-xl-3"
              >
              ...
              <div class="row align-items-center g-3 g-sm-4 pb-3">
                ...
                <div class="col-sm-6">
                  <a
                    class="d-inline-block fs-sm fw-semibold text-decoration-none mt-sm-4"
