...
<div class="container mb-10">
    ...
    <div class="col-5">
        <!-- 왼쪽 카드의 부모 -->
        <div class="card image-card d-flex flex-column">
    ...
    <div class="col-3">
        ...
        <div class="card-body pb-5 flex-grow-1">
            ...
            <div class="d-flex justify-content-between gap-4">
                ...
                <div class="text-end">
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">100원</span>
                <span class="d-block text-sm text-heading fw-bold">1일</span>
                </div>
            </div>
            </div>
        </div>
