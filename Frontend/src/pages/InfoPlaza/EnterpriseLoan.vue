      ...
      <div class="d-flex justify-content-center align-items-center">
        <div class="row">
          <div class="d-flex align-items-center mb-6">
            ...
            />
            <h2 class="ms-2">Best 금리 상품</h2>
          </div>
        </div>
      </div>
      <div class="card mb-20 p-2" style="background-color: #f6f4f9">
        <!-- Best 금리상품 내용-->
        <div class="row">
          <!-- 카드 1개 -->
          <div class="col-xl-3">
                      ...
                      <div class="carousel-item active">
                        <div class="carousel-wrapper">
                          <div class="d-flex flex-column flex-grow-1">
                            ...
                            >
                              <p class="fs-5 text-gray-600 mb-1">금리</p>
                              <p class="h1 fw-bold mb-0 ms-2">3.83%</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
import LoanHeader from '@/components/infoplaza/EnterpriseLoanHeader.vue';
</script>
